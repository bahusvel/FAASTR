...
pub fn parse_term_arg(data: &[u8], ctx: &mut AmlExecutionContext) -> ParseResult {
    match ctx.state {
        ExecutionState::EXECUTING => (),
        _ => {
            return Ok(AmlParseType {
...
pub fn parse_object_list(data: &[u8], ctx: &mut AmlExecutionContext) -> ParseResult {
    match ctx.state {
        ExecutionState::EXECUTING => (),
        _ => {
            return Ok(AmlParseType {
...
fn parse_object(data: &[u8], ctx: &mut AmlExecutionContext) -> ParseResult {
    match ctx.state {
        ExecutionState::EXECUTING => (),
        _ => {
            return Ok(AmlParseType {
...
pub fn parse_method_invocation(data: &[u8], ctx: &mut AmlExecutionContext) -> ParseResult {
    match ctx.state {
        ExecutionState::EXECUTING => (),
        _ => {
            return Ok(AmlParseType {
...
fn parse_term_obj(data: &[u8], ctx: &mut AmlExecutionContext) -> ParseResult {
    match ctx.state {
        ExecutionState::EXECUTING => (),
        _ => {
            return Ok(AmlParseType {
