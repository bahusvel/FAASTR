...
impl Descriptor {
    ...
    pub fn kernel_code_segment() -> Descriptor {
        ...
        let flags =
            Flags::USER_SEGMENT | Flags::PRESENT | Flags::EXECUTABLE | Flags::LONG_MODE | Flags::RW;
    ...
    pub fn kernel_data_segment() -> Descriptor {
        ...
        let flags = Flags::USER_SEGMENT | Flags::PRESENT | Flags::LONG_MODE | Flags::RW;
        Descriptor::UserSegment(flags.bits())
    }
    ...
    pub fn tss_segment(tss: &TaskStateSegment) -> Descriptor {
        ...
        let mut low = (Flags::PRESENT | Flags::Ring3).bits();
        // base
    ...
    pub fn tcb_segment(ptr: u64) -> Descriptor {
        use self::DescriptorFlags as Flags;
        use bit_field::BitField;
        use core::mem::size_of;

        let mut low = (Flags::USER_SEGMENT | Flags::PRESENT | Flags::LONG_MODE | Flags::RW).bits();
        // base
        low.set_bits(16..40, ptr.get_bits(0..24));
        low.set_bits(56..64, ptr.get_bits(24..32));
        // limit (the `-1` in needed since the bound is inclusive)
        low.set_bits(0..16, (0 as u64));
